...
namespace SistemaQuickCarry
{
    class Empleados
    {
        ...
        public byte Guardar()
        {
            ...
            {
                sql = $"INSERT INTO Empleado (CI, Usuario, PrimerNombre, SegundoNombre, PrimerApellido, SegundoApellido, EsAdmin) " +
                      $"VALUES ({_ci}, '{_usuario}', '{_primerNombre}', '{_segundoNombre}', '{_primerApellido}', '{_segundoApellido}', , " +
                      $"CASE " +
